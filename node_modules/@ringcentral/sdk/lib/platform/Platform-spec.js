...
describe('RingCentral.platform.Platform', function () {
    ...
    describe('login', function () {
        ...
        it('login with JWT', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            var platform, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('login with username/password', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            var platform, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('login with code from usePKCE flow without client secret', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        authData = _a.sent();
                        test_1.expect(authData.access_token).to.equal('ACCESS_TOKEN');
                        test_1.expect(authData.code_verifier).not.to.be.empty;
                        return [2 /*return*/];
                }
            });
        }); }, {
        ...
        it('login with code and code_verifier', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            var platform, authData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        authData = _a.sent();
                        test_1.expect(authData.code_verifier).to.equal('test_code_verifier');
                        return [2 /*return*/];
                }
            });
        }); }, {
        ...
        it('login with code and code_verifier with client secret', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        test_1.expect(request.headers.get('authorization')).not.to.equal(null);
                        return [4 /*yield*/, platform.auth().data()];
                    case 2:
                        authData = _a.sent();
                        test_1.expect(authData.access_token).to.equal('ACCESS_TOKEN');
        ...
        it('login with code without clientSecret', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            var platform, client, request, authData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        test_1.expect(request.headers.get('authorization')).to.equal(null);
                        test_1.expect(request.body || request.originalBody).have.string('client_id=whatever');
                        return [4 /*yield*/, platform.auth().data()];
                    case 2:
                        authData = _a.sent();
                        test_1.expect(authData.access_token).to.equal('ACCESS_TOKEN');
    ...
    describe('refresh', function () {
        ...
        it('not skip auth header when auth data with clientSecret', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
        ...
        it('skip auth header when auth data without client secret', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            var platform, client, request, authData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        authData = _a.sent();
                        test_1.expect(authData.access_token).to.equal('ACCESS_TOKEN_FROM_REFRESH');
                        return [2 /*return*/];
                }
            });
        }); }, {
    ...
    describe('get, post, put, patch, delete', function () {
        ...
        it('send request with user agent option', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        test_1.apiCall('get', path, { foo: 'bar' });
                        client.on(client.events.requestSuccess, function (_, r) {
                            request = r;
                        });
                    ...
                    case 1:
                        _a.sent();
                        test_1.expect(request.headers.get('x-user-agent')).have.string('TestAgent');
                        return [2 /*return*/];
                }
            });
        }); }));
    ...
    describe('loginUrl', function () {
        it('simple usage', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                test_1.expect(platform.loginUrl.bind(platform, {
                    implicit: true,
                    usePKCE: true,
    ...
    describe('logout', function () {
        it('should skip auth header when auth without client secret', test_1.asyncTest(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
            var platform, client, request, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    describe('discovery initial', function () {
        ...
        it('should fetch initial discovery and set auth endpoint on init', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        initialDiscoveryData = test_1.getInitialDiscoveryMockData();
                        test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', initialDiscoveryData);
                        sdk = test_1.createSdk({ enableDiscovery: true, discoveryServer: 'http://whatever', server: '' });
                        platform = sdk.platform();
                    ...
                    case 2:
                        ...
                        test_1.expect(loginUrl.indexOf(initialDiscoveryData.authApi.authorizationUri)).to.equal(0);
                        test_1.expect(loginUrl.indexOf('discovery=true') > -1).to.equal(true);
                        _a = test_1.expect;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        test_1.expect(error.message).to.equal('Client Id is required for discovery');
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.timeout(20000);
                            test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', { description: 'Fail' }, 500);
                            test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', { description: 'Fail' }, 500);
                            test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', { description: 'Fail' }, 500);
                            sdk = test_1.createSdk({ enableDiscovery: true, discoveryServer: 'http://whatever', server: '' });
                            platform = sdk.platform();
                            requestErrorSpy = test_1.spy(function () { });
                        ...
                        case 4:
                            ...
                            test_1.expect(discovery.initialized).to.equal(false);
                            test_1.expect(requestErrorSpy.calledThrice).to.equal(true);
                            loginUrlError = false;
                            try {
                                platform.loginUrl();
                            }
                            ...
                            test_1.expect(loginUrlError).to.equal(true);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('should fetch external discovery when login with discovery_uri and token_uri', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        initialDiscoveryData = test_1.getInitialDiscoveryMockData();
                        externalDiscoveryData = test_1.getExternalDiscoveryMockData();
                        test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', initialDiscoveryData);
                        test_1.apiCall('GET', '/.well-known/entry-points/external', externalDiscoveryData);
                        test_1.authentication();
                        sdk = test_1.createSdk({ enableDiscovery: true, discoveryServer: 'http://whatever', server: '' });
                        platform = sdk.platform();
                        return [4 /*yield*/, platform.login({
                    ...
                    case 2:
                        ...
                        test_1.expect(externalData.coreApi.baseUri).to.equal(externalDiscoveryData.coreApi.baseUri);
                        _a = test_1.expect;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', initialDiscoveryData);
                            test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', initialDiscoveryData);
                            test_1.apiCall('GET', '/.well-known/entry-points/external', null, 500);
                            test_1.apiCall('GET', '/.well-known/entry-points/external', null, 500);
                            test_1.apiCall('GET', '/.well-known/entry-points/external', null, 500);
                            test_1.authentication();
                            sdk = test_1.createSdk({ enableDiscovery: true, discoveryServer: 'http://whatever', server: '' });
                            platform = sdk.platform();
                            clientFetchErrorSpy = test_1.spy(function () { });
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 4];
                        case 4:
                            test_1.expect(hasError).to.equal(true);
                            test_1.expect(clientFetchErrorSpy.calledThrice).to.equal(true);
                            return [2 /*return*/];
                    }
                });
            });
    ...
    describe('API request with discovery', function () {
        ...
        it('should fetch api request successfully', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        test_1.expect(data.increment).to.equal(1);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should fetch rcv api request successfully', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        test_1.apiCall('GET', '/rcvideo/v1/bridges', { id: 123 });
                    ...
                    case 2:
                        data = _a.sent();
                        test_1.expect(data.id).to.equal(123);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should refresh token successfully', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        test_1.expect(noErrors).to.equal(true);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should logout successfully', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        initialData = _a.sent();
                        test_1.expect(initialData.authApi.authorizationUri).to.equal(initialDiscoveryData.authApi.authorizationUri);
                        test_1.expect(loginUrl.indexOf(initialDiscoveryData.authApi.authorizationUri)).to.equal(0);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should init discovery when logout error', function () { return __awaiter(_this, void 0, void 0, function () {
            var initialDiscoveryData, hasError, e_4, initialData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        test_1.cleanFetchMock();
        ...
        it('should login successfully after logout', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        it('should trigger refresh external discovery data when Discovery-Required', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        test_1.apiCall('GET', '/restapi/v1.0/foo/1', { increment: 1 }, 200, 'OK', {
                    ...
                    case 5:
                        discovery = _a.sent();
                        test_1.expect(discovery.version).to.equal(externalDiscoveryData.version);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            discovery = _a.sent();
                            test_1.expect(discovery.version).to.equal('1.0.0');
                            test_1.expect(platform.discovery().externalRetryCycleScheduled).to.equal(true);
    ...
    describe('Init discovery with clearCacheOnRefreshError flag ', function () {
        ...
        it('should init discovery when login error', function () { return __awaiter(_this, void 0, void 0, function () {
            var initialDiscoveryData, hasError, e_5, initialData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        test_1.cleanFetchMock();
                        test_1.authentication(502);
                        initialDiscoveryData = test_1.getInitialDiscoveryMockData();
                        initialDiscoveryData.authApi.authorizationUri = 'http://whatever1/restapi/oauth/authorize';
                        test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', initialDiscoveryData);
                        hasError = false;
        ...
        it('should init discovery when refresh error', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // mock
                        test_1.apiCall('GET', '/.well-known/entry-points/initial?clientId=whatever', initialDiscoveryData);
                        test_1.apiCall('GET', '/.well-known/entry-points/external', externalDiscoveryData, 200, 'OK', {
        ...
        it('should save tag in external discovery data', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        externalData = _a.sent();
                        test_1.expect(externalData.tag).to.equal(discoveryTag);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should send Discovery-Tag header in api request', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        test_1.expect(request.headers.get('discovery-tag')).to.equal(discoveryTag);
                        return [2 /*return*/];
                }
            });
        }); });
